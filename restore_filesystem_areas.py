...
def restore_filesystem_areas():
    ...
    critical_areas = [
        ...
        # NUOVE AREE - Identificate dall'analisi completa (27/12/2025)
        # Queste aree erano NON COPERTE e causavano "damaged saves"!
        (0x00050000, 0x00001000, "QCOW2_L2_Table"),      # Struttura QCOW2
        (0x0f730000, 0x00010000, "Extended_Data_1"),     # Dati gioco estesi
        (0x118f0000, 0x00010000, "Extended_Data_2"),     # SaveMeta.xbx area
        (0x14520000, 0x00010000, "Extended_Data_3"),     # saveimage area
    ]
